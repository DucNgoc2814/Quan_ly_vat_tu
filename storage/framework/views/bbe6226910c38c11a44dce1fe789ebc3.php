    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-danger menu-link" href="<?php echo e(route('admin.dashboard')); ?>" role="button"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarEmployees">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('employees.index')); ?>" class="nav-link text-danger"
                                    data-key="t-horizontal">Danh sách nhân sự</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('employees.listPermissions')); ?>" class="nav-link text-danger"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarSliders">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('sliders.index')); ?>" class="nav-link text-danger"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarGalleries">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('units.index')); ?>" class="nav-link text-danger"
                                    data-key="t-horizontal">Quản lý đơn vị</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('brand.index')); ?>" class="nav-link text-danger"
                                    data-key="t-horizontal">Quản lý thương hiệu</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('inventories.index')); ?>" class="nav-link text-danger"
                                    data-key="t-horizontal">Quản lý kho hàng</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('valueVariations.index')); ?>" class="nav-link text-danger"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarBrands">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('contract.index')); ?>" class="nav-link text-danger"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarCargoCarTypers">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('CargoCars.index')); ?>" class="nav-link text-danger"
                                    data-key="t-horizontal">Danh sách xe</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('cargo_car_types.index')); ?>" class="nav-link text-danger"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarOrders">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('order.index')); ?>" class="nav-link text-danger"
                                    data-key="t-horizontal">Đơn hàng</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('importOrder.index')); ?>" class="nav-link text-danger"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarTrips">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('trips.index')); ?>" class="nav-link" data-key="t-horizontal">Danh
                                    sách chuyến đi</a>
                            </li>
                        </ul>
                    </div>
