            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo e(asset('themes/admin/assets/images/logoweb')); ?>" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo e(asset('themes/admin/assets/images/logoweb')); ?>" alt="" height="17">
                        </span>
                    </a>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="<?php echo e(asset('storage/' . (Session::get('employee')->image ?? 'themes/admin/assets/pro/default-user.jpg'))); ?>"
                                alt="Header Avatar">
