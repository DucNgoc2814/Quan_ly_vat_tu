...
(function (l) {
    ...
    function Kb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            h = a.aanFeatures,
          f = '<input style="width=15%" type="search" class="form-control' + b.sFilterInput + '" />',
            g = d.sSearch;
        ...
        var m = l("input", b)
            ...
            .on("keyup.DT search.DT input.DT paste.DT cut.DT", h ? hb(k, h) : k)
            ...
            if (!f._aFilterData) {
                ...
                for (d = b.length; e < d; e++) {
                    ...
                    k.indexOf &&
                        -1 !== k.indexOf("&") &&
                        ((Qa.innerHTML = k),
                        (k = tc ? Qa.textContent : Qa.innerText));
    ...
    function fc(a) {
        return function () {
            var b = [Ta(this[u.ext.iApiIndex])].concat(
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    f = function () {
                        ...
                        0 === H.length || 0 === H.children().length
                            ...
                            : 0 < H.length &&
                              ((r.nTFoot = H[0]), wa(r.aoFooter, r.nTFoot));
                        if (g.aaData)
    ...
    y("row().child()", function (a, b) {
        ...
        !0 === a
            ...
            : !1 === a
            ? xb(this)
            : c.length && this.length && zc(c[0], c[0].aoData[this[0]], a, b);
        return this;
    });
