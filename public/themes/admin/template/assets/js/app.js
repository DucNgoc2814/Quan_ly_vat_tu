!(function() {
      ...
      (
        ...
        Array.from(
          ...
          a.querySelectorAll("span").forEach(function(e) {
            ...
            e.classList.add(
              "active"
            ), t.appendChild(a), n.appendChild(t), a.classList.contains("nav-link") && a.classList.replace("nav-link", "nav-icon"), a.classList.remove("collapsed", "menu-link");
        }),
        (e = (e =
          "/" == location.pathname
            ? "index.html"
  ...
  function O() {
    ...
    767 < e &&
      document
        .querySelector(".hamburger-icon")
        .classList.toggle("open"), "horizontal" ===
      document.documentElement.getAttribute("data-layout") &&
      (document.body.classList.contains("menu")
        ? document.body.classList.remove("menu")
        : document.body.classList.add("menu")), "vertical" ===
      document.documentElement.getAttribute("data-layout") &&
      (e <= 1025 && 767 < e
        ? (
            document.body.classList.remove("vertical-sidebar-enable"),
  ...
  function G() {
    document.addEventListener("DOMContentLoaded", function() {
      ...
      "resize",
      m
    ), m(), Waves.init(), document.addEventListener("scroll", function() {
      var e;
              ...
              e.parentElement.closest(".collapse.menu-dropdown")
                ? (
                    ...
                    e.parentElement.parentElement.parentElement.parentElement.closest(
                      ...
                      (
                        (t = e.parentElement.parentElement.parentElement.parentElement
                          .closest(".collapse.menu-dropdown")
                          .getAttribute("id")),
                        e.parentElement.parentElement.parentElement.parentElement
                          .closest(".collapse.menu-dropdown")
      ...
      Array.from(e).forEach(function(o) {
        !(function e() {
          var t = +o.getAttribute("data-target"),
            ...
            n = t / 250;
          n < 1 &&
            (n = 1), a < t ? ((o.innerText = (a + n).toFixed(0)), setTimeout(e, 1)) : (o.innerText = s(t)), s(o.innerText);
        })();
      });
  }
  ...
  function b() {
    (document.getElementById("two-column-menu").innerHTML =
      ...
      (document.querySelector(
        ".navbar-menu"
      ).innerHTML = d), document
      .getElementById("scrollbar")
      .removeAttribute("data-simplebar"), document
      .getElementById("navbar-nav")
      .removeAttribute("data-simplebar"), document
      .getElementById("scrollbar")
    ...
    Array.from(n).forEach(function(e, t) {
      t + 1 === a &&
        (s = e), a < t + 1 && ((o += e.outerHTML), e.remove()), t + 1 === n.length && s.insertAdjacentHTML && s.insertAdjacentHTML("afterend", '<li class="nav-item">\t\t\t\t\t\t<a class="nav-link" href="#sidebarMore" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMore">\t\t\t\t\t\t\t<i class="ri-briefcase-2-line"></i> <span data-key="t-more">More</span>\t\t\t\t\t\t</a>\t\t\t\t\t\t<div class="collapse menu-dropdown" id="sidebarMore"><ul class="nav nav-sm flex-column">' + o + "</ul></div>\t\t\t\t\t</li>");
    });
  }
  ...
  function e(e) {
    if (e == e) {
      switch (e["data-layout"]) {
        case "vertical":
          T("data-layout", "vertical"), sessionStorage.setItem(
            "data-layout",
            "vertical"
          ), document.documentElement.setAttribute(
            "data-layout",
          ...
          break;
        case "horizontal":
          T("data-layout", "horizontal"), sessionStorage.setItem(
            "data-layout",
            "horizontal"
          ), document.documentElement.setAttribute(
            "data-layout",
          ...
          break;
        case "twocolumn":
          T("data-layout", "twocolumn"), sessionStorage.setItem(
            "data-layout",
            "twocolumn"
          ), document.documentElement.setAttribute(
            "data-layout",
        ...
        case "semibox":
          T("data-layout", "semibox"), sessionStorage.setItem(
            "data-layout",
            "semibox"
          ), document.documentElement.setAttribute("data-layout", "semibox"), y(
            "semibox"
          );
          break;
        default:
      ...
      switch (e["data-topbar"]) {
        case "light":
          T("data-topbar", "light"), sessionStorage.setItem(
            "data-topbar",
            "light"
          ), document.documentElement.setAttribute("data-topbar", "light");
          break;
        case "dark":
          T("data-topbar", "dark"), sessionStorage.setItem(
            "data-topbar",
            "dark"
      ...
      switch (e["data-sidebar"]) {
        case "light":
          T("data-sidebar", "light"), sessionStorage.setItem(
            "data-sidebar",
            "light"
          ), document.documentElement.setAttribute("data-sidebar", "light");
          break;
        case "dark":
          T("data-sidebar", "dark"), sessionStorage.setItem(
            "data-sidebar",
            "dark"
          ), document.documentElement.setAttribute("data-sidebar", "dark");
          break;
        case "gradient":
          T("data-sidebar", "gradient"), sessionStorage.setItem(
            "data-sidebar",
            "gradient"
        ...
        "semibox" == document.documentElement.getAttribute("data-layout") &&
          ...
          document.documentElement.getAttribute("data-sidebar-visibility")
            ...
            : (
              ...
              )), (document.getElementById("sidebar-size").style.display = t), (document.getElementById("sidebar-color").style.display = t), document.getElementById("sidebar-img") && (document.getElementById("sidebar-img").style.display = t), "data-preloader" ==
          n && "enable" == a.value
          ? (
  ...
  function F() {
    var t = 0;
    Array.from(
      document.getElementsByClassName("cart-item-price")
    ).forEach(function(e) {
  ...
  sessionStorage.getItem("defaultAttribute")
    ? (
        ...
        (f["data-sidebar-image"] = sessionStorage.getItem(
          "data-sidebar-image"
        )),
              ...
              Array.from(t).forEach(function(e) {
                ...
                e.querySelector("h6")
                  ...
                  : e.getElementsByTagName("span") &&
                    (n = e
                      .getElementsByTagName("span")[0]
                      .innerText.toLowerCase()), n && (e.style.display = n.includes(o) ? "block" : "none");
              })
            )
          : (v.classList.remove("show"), h.classList.add("d-none"));
      }),
  ...
  )), (A = document.getElementById("search-options-reponsive")), S &&
    w &&
    A &&
    (
    ...
    "HTML"
  )[0]), (z = document.querySelectorAll(".light-dark-mode")) &&
    z.length &&
    ...
    (
      ...
      Array.from(
        ...
        e.addEventListener("click", function(e) {
          k--, this.closest(".dropdown-item-cart").remove(), Array.from(
            document.getElementsByClassName("cartitem-badge")
          ).forEach(function(e) {
            e.innerHTML = k;
          }), F(), document.getElementById("empty-cart") &&
            (document.getElementById("empty-cart").style.display =
              0 == k
                ? "block"
                : "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = 0 == k ? "none" : "block");
        });
      }),
      Array.from(
        document.getElementsByClassName("cartitem-badge")
    ...
    (
      ...
      Array.from(
        ...
        t.addEventListener("change", function(e) {
          ...
          var t = document.querySelectorAll(".notification-check input:checked")
            .length;
          e.target
            .closest(".notification-item")
            .classList.contains(
              "active"
            ), (document.getElementById("notification-actions").style.display = 0 < t ? "block" : "none"), (document.getElementById("select-content").innerHTML = t);
        }), document
      ...
      document.addEventListener("DOMContentLoaded", function() {
        var removeNotificationModal = document.getElementById(
        ...
        if (removeNotificationModal) {
          removeNotificationModal.addEventListener("show.bs.modal", function(
            e
          ) {
            if (deleteNotification) {
              deleteNotification.addEventListener("click", function() {
                // Xử lý loại bỏ các phần tử notification có class 'active'
                Array.from(
                ...
                H(); // Giả sử H() là một hàm có sẵn để gọi
                document.getElementById("NotificationModalbtn-close").click(); // Đóng modal
              });
            }
          });
        }
    ...
    document
      ...
      }), (z = document.querySelectorAll("[data-toast]")), Array.from(
    z
  ).forEach(function(a) {
  ...
  }), (z = document.querySelectorAll("[data-choices]")), Array.from(
    z
  ).forEach(function(e) {
    var t = {},
      a = e.attributes;
