                    ...
                    <form action="{{route('sliders.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <input type="file" name="url_" id="url_" class="from-control @error('url_') is-invalid @enderror" onchange="showImage(event)" >
                                <img src="" alt="" id="img_slider" style="width: 150px; display: none;" class="mt-3"> 
