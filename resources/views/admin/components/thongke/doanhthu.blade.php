...
@section('content')
    ...
    <script>
        ...
        console.log(KhoanChiThuc, KhoanChi);
        new Chart("myChart2", {
            type: "line",
            data: {
                labels: xValues2,
