    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('cargo_car_types.edit') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-8">
                            ...
                            <div class="col-lg-8 mt-3">
                                ...
                                <input type="text" name="capacity" placeholder="Nhập trọng tải cần sửa" class="form-control"
                                    class="form-control value="{{ $item->capacity }}">
                                @error('capacity')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
