    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Thêm loại xe</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('cargo_car_types.index') }}">Danh sách loại xe</a></li>
                        <li class="breadcrumb-item active">Thêm loại xe</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card-header border-0 mb-4">
        <div class="row g-4">
            <div class="col-sm-auto">
                <a href="{{ route('cargo_car_types.index') }}" class="btn btn-success" id="addproduct-btn"><i
