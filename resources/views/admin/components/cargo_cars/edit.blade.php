                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                {{-- <select name="is_active" id="status" class="form-control">
                                   <option value="1" {{old('is_active', $cargo_car->is_active) == 1 ? 'selected' : '' }}>Đang vận chuyển</option>
                                   <option value="0" {{old('is_active', $cargo_car->is_active) == 0 ? 'selected' : '' }}>Chờ xác nhận</option>
