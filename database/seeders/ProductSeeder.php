...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('products')->insert([
            ...
            ['id' => 3, 'category_id' => 3, 'unit_id' => 3, 'slug' => 2, 'image' => '12312321', 'brand_id' => 2, 'name' => 'Sắt thép xây dựng', 'description' => 'Sắt thép chịu lực tốt, sử dụng cho các công trình xây dựng.', 'is_active' => 1],
